...
// 만약 필터 버튼 누르면 -> min, max, discount 값을 받아옴
// -> 값을 이용하여 해당하는 물품을 추출 -> 다시 화면에 나타냄
...
export const setButtonEvent = (productList) => {
  filterButton.onclick = () => {
    ...
    // console.log(maxPrice, minPrice, discountPrice);
...
export const setFilterEvent = () => {
  ...
  // 필터 입력창 -> 사용자가 클릭 -> 숫자
  // 필터 입력창 이외의 부분 -> 사용자가 클릭 ->
  // 입력창에서 벗어남 -> '원', '%'가 붙은 format된 형태
